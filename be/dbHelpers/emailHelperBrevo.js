...
const CHURCH_EMAIL = process.env.BREVO_FROM_EMAIL || 'bbekkawit@gmail.com';
...
const sendAccountDetails = async (accountDetails) => {
  try {
    ...
    const token = accountDetails.token || accountDetails.resetToken || Math.random().toString(36).substring(2, 15);
    ...
    sendSmtpEmail.htmlContent = getEmailHeader(title) + `
    ...
    sendSmtpEmail.to = [{ email: accountDetails.email, name: recipientName }];
...
const sendWaterBaptismDetails = async (baptismDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `Water Baptism Update - ${status.charAt(0).toUpperCase() + status.slice(1)}`;
    sendSmtpEmail.htmlContent = getEmailHeader('Water Baptism Service Update') + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: baptismDetails.email, name: recipientName }];
...
const sendChildDedicationDetails = async (dedicationDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `Child Dedication Update - ${status.charAt(0).toUpperCase() + status.slice(1)}`;
    sendSmtpEmail.htmlContent = getEmailHeader('Child Dedication Service Update') + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: dedicationDetails.email, name: recipientName }];
...
const sendBurialDetails = async (burialDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `Burial Service Update - ${status.charAt(0).toUpperCase() + status.slice(1)}`;
    sendSmtpEmail.htmlContent = getEmailHeader('Burial Service Update') + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: burialDetails.email, name: recipientName }];
...
const sendMarriageDetails = async (marriageDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `Marriage Service Update - ${status.charAt(0).toUpperCase() + status.slice(1)}`;
    sendSmtpEmail.htmlContent = getEmailHeader('Marriage Service Update') + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: marriageDetails.email, name: recipientName }];
...
const sendBurialServiceRequestNotification = async (requestDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `Burial Service Request Received - ${CHURCH_NAME}`;
    sendSmtpEmail.htmlContent = getEmailHeader('Burial Service Request Received') + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: requestDetails.email, name: recipientName }];
...
const sendApprovalRequestNotification = async (approvalDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `${typeLabel} Join Request Received - ${CHURCH_NAME}`;
    sendSmtpEmail.htmlContent = getEmailHeader(`${typeLabel} Join Request Received`) + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: approvalDetails.email, name: recipientName }];
...
const sendApprovalStatusUpdate = async (approvalDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `${typeLabel} Request ${status.charAt(0).toUpperCase() + status.slice(1)} - ${CHURCH_NAME}`;
    sendSmtpEmail.htmlContent = getEmailHeader(`${typeLabel} Request Update`) + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
...
const sendTransactionCompletionNotification = async (transactionDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `Transaction Completed - ${serviceTypeLabel} - ${CHURCH_NAME}`;
    sendSmtpEmail.htmlContent = getEmailHeader('Transaction Completed') + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: transactionDetails.email, name: recipientName }];
...
const sendFormSubmissionNotification = async (formDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `${formTypeLabel} Received - ${CHURCH_NAME}`;
    sendSmtpEmail.htmlContent = getEmailHeader(`${formTypeLabel} Received`) + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
    ...
    sendSmtpEmail.to = [{ email: formDetails.email, name: recipientName }];
...
const sendFormStatusUpdate = async (formDetails) => {
  try {
    ...
    const sendSmtpEmail = new Brevo.SendSmtpEmail();
    sendSmtpEmail.subject = `${formTypeLabel} ${status.charAt(0).toUpperCase() + status.slice(1)} - ${CHURCH_NAME}`;
    sendSmtpEmail.htmlContent = getEmailHeader(`${formTypeLabel} Update`) + `
      <p style="font-size: 16px; color: #555;">Dear ${recipientName},</p>
      <p style="font-size: 15px; color: #555;">${statusMessages[status] || 'Your request status has been updated.'}</p>
      ${getStatusBadge(status, {}, statusMessages)}
